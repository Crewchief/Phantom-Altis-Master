...
_Admins = ["76561198131033433","76561198101338582","76561198047071933","76561198051254596"];
...
_exists = loadFile "core\admin\AdminMenu.sqf";
if(_exists != "") then {
	call compile preprocessfilelinenumbers "core\admin\AdminMenu.sqf";
};