...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","yeast_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["yeast"]): {"yeast_1"};
	case (_zone in ["oil_1","oil_2"]): {"oilu"};
	case (_zone in ["rock_1"]): {"rock"};
	case (_zone in ["grape_1","grape_2","grape_3"]): {"grape"};
	case (_zone in ["lithium_1","lithium_2"]): {"lithium"};
	case (_zone in ["phosphorous_1","phosphorous_2"]): {"phosphorous"};
	case (_zone in ["ephedra_1"]): {"ephedra"};
	case (_zone in ["sugar_1","sugar_2"]): {"sugar"};
	case (_zone in ["corn_1","corn_2"]): {"corn"};
	case (_zone in ["yeast_1","yeast_2","yeast_3"]): {"yeast"};
	case (_zone in ["frog_1","frog_2","frog_3","frog_4","frog_5"]): {"frog"};
	default {""};
};
