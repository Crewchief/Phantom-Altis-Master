...
//Stop players from using trunk while processing, Prevent Duplication glitch
if(life_is_processing) exitWith {hint "You cannot access trunk inventory while processing."};
