...
case "Frog": { _profName = "Frog_Prof";};
case "Crystal_Meth": { _profName = "Crystal_Meth_Prof";};
...
case "Uranium": { _profName = "Uranium";};
case "Wine": { _profName = "Wine";};
case "Moonshine": { _profName = "Moonshine";};
case "Frog": { _profName = "Frog";};
case "Crystal_Meth": { _profName = "Crystal Meth";};
default{""};
};
