...
/*
	...
	Description:
	Master config file for Rebel clothing store.
*/
...
switch (_filter) do
{
	...
	case 0:
	{
		_ret =
		[
			["U_B_GhillieSuit",nil,1500 * life_donDis],
			["U_O_GhillieSuit",nil,1500 * life_donDis],
			["U_I_GhillieSuit",nil,1500 * life_donDis],
			["U_B_CombatUniform_mcam_tshirt",nil,800 * life_donDis],
			["U_B_CombatUniform_mcam_vest",nil,800 * life_donDis],
			["U_I_CombatUniform_shortsleeve",nil,800 * life_donDis],
			["U_B_CTRG_1",nil,800 * life_donDis],
			["U_B_CTRG_2",nil,800 * life_donDis],
			["U_B_CTRG_3",nil,800 * life_donDis],
			["U_I_G_resistanceLeader_F",nil,800 * life_donDis],
			["U_IG_leader",nil,500 * life_donDis],
			["U_IG_Guerilla1_1",nil,500 * life_donDis],
			["U_BG_leader","Guerilla Smocks 1",500 * life_donDis],
			["U_O_PilotCoveralls",nil,600 * life_donDis],
			["U_O_CombatUniform_ocamo",nil,800 * life_donDis],
			["U_O_CombatUniform_oucamo",nil,800 * life_donDis],
			["U_O_SpecopsUniform_ocamo",nil,800 * life_donDis],
			["U_B_SpecopsUniform_sgg",nil,800 * life_donDis],
			["U_O_OfficerUniform_ocamo",nil,800 * life_donDis],
			["U_I_OfficerUniform",nil,800 * life_donDis],
			["U_O_Wetsuit",nil,1000 * life_donDis],
			["U_C_Scientist","Hazmat Suit",20000 * life_donDis]
		];
		...
		{
			_ret set[count _ret,["U_I_Protagonist_VR",nil,500 * life_donDis]];
	...
	case 1:
	{
		_ret =
		[
			["H_HelmetB_camo","ECH (Camo)",1500 * life_donDis],
			...
			["H_PilotHelmetFighter_I","Hazmat Helmet",5000]
		];
		if(__GETC__(life_donatorlvl) > 0) then
		{
	...
	case 3:
	{
		...
		[
			...
			["V_HarnessOGL_brn","Suicide Vest",220000 * life_donDis],
	...
	case 4:
	{
		_ret =
		[
			["B_AssaultPack_blk",nil,200 * life_donDis],
			["B_AssaultPack_cbr",nil,200 * life_donDis],
			["B_AssaultPack_khk",nil,200 * life_donDis],
			["B_AssaultPack_sgg",nil,200 * life_donDis],
			["B_AssaultPack_rgr",nil,200 * life_donDis],
			...
			["B_Bergen_sgg",nil,700 * life_donDis],
