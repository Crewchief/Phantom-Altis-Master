			...
			switch (true) do {
				...
				case(_x getVariable["coplevel", 0] > 0) : {
					switch (_x getVariable["coplevel", 0]) do {
						case (1) : {_name = format["Cadet %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\private_gs.paa";};
						case (2) : {_name = format["Constable %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\corporal_gs.paa";};
						case (3) : {_name = format["K9 Officer %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\corporal_gs.paa";};
						case (4) : {_name = format["Sergeant %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\sergeant_gs.paa";};
						case (5) : {_name = format["Lieutenant %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\lieutenant_gs.paa";};
						case (6) : {_name = format["Chief of Police %1", name _x];_icon = "a3\UI_F\data\GUI\Cfg\Ranks\captain_gs.paa";};
