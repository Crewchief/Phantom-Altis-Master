...
_title = "Capturing Hideout, stay close (30m)...";
...
while {true} do
{
	...
	if(isNull _ui) then {
		...
		_Pos = position player; // by ehno: get player pos																		  	  Avitus
				                ...
				                "Marker200" setMarkerText "!ATTENTION! GANG TAKEOVER IN PROGRESS !ATTENTION!";						//Avitus
...
if(player distance _hideout > 30) exitWith {_hideout setVariable["inCapture",false,true];};											//Avitus
